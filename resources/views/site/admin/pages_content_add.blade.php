<div class="wrapper content-fluid">
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			{!! Form::textarea('text', old('text'), ['id'=>'editor','class'=>'form-control', 'placeholder'=>'text']) !!}
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			{!! Form::file('img', old('text'), ['class'=>'filestyle', 'data-buttontext'=>'Выберете изображение', 'data-buttonName'=>'btn btn-primary', 'data-placeholder'=>'Файла нет']) !!}
		</div>
	</div>
